...
const vcard1 = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n'
            + 'FN:WH173 5P1D3R\n'
            + 'ORG:second number of Owner WH173 5P1D3R;\n'
            + 'TEL;type=CELL;type=VOICE;waid=917994876705:+917994876705\n'
            + 'END:VCARD'

prefix = "#"
name = "WH173 5P1D3R BOT"
rdaftar = "REJISTER SUCCESFULLY"
rmenu = "WH173 5P1D3R BOT MENU"
botinfo = "WH173 5P1D3R BOT INFO"
limitt = 999999999
memberLimit = 0
ban = []
...
async function starts() {
	...
	denz.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `*_ʜᴀʟʟᴏ👋_* @${num.split('@')[0]}\n ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴏᴜʀ ɢʀᴏᴜᴘ *${mdata.subject}*`
				...
				teks = `*_「 ᴘʀᴏᴍᴏᴛᴇ ᴅᴇᴛᴇᴄᴛᴇᴅ 」_*\n@${num.split('@')[0]} ʏᴏᴜʀ ᴀʀᴇ ɴᴏᴡ ᴀɴ ᴀᴅᴍɪɴ`
				let buff = await getBuffer(ppimg)
				denz.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
				...
				teks = `*_ʙʏᴇ👋_* @${num.split('@')[0]} sᴇᴇ ʏᴏᴜ ɴᴇxᴛ ᴛɪᴍᴇ`
				let buff = await getBuffer(ppimg)
				denz.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	denz.on('chat-update', async (mek) => {
		try {
			...
			const FarhanGans = ["917736807522@s.whatsapp.net"] // ubah aja gapapa
			...
			mess = {
				wait: '*⏳ ᴡᴀɪᴛ ɪs ɪɴ ᴘʀᴏᴄᴇss...*',
				success: '*sᴜᴄᴄᴇss...*',
				error: {
					stick: '*ғᴀɪʟᴇᴅ, ᴀɴ ᴇʀʀᴏʀ ᴏᴄᴄᴜʀʀᴇᴅ ᴡʜɪʟᴇ ᴄᴏɴᴠᴇʀᴛɪɴɢ ᴛʜᴇ ɪᴍᴀɢᴇ ᴛᴏ ᴀ sᴛɪᴄᴋᴇʀ*',
					Iv: '*sᴏʀʀʏ ᴛʜᴇ ʟɪɴᴋ ɪs ɪɴᴠᴀʟɪᴅ!*'
				},
				only: {
					group: '*sᴏʀʀʏ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜsᴇᴅ ɪɴ ɢʀᴏᴜᴘs!*',
					benned: '*sᴏʀʀʏ ʏᴏᴜʀ ɴᴜᴍʙᴇʀ ᴡᴀs ʙᴀɴɴᴇᴅ, ᴘʟᴇᴀsᴇ ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ ᴏᴡɴᴇʀ ᴛᴏ ᴜɴʙᴀɴ*',
					ownerG: '*sᴏʀʀʏ, ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜsᴇᴅ ʙʏ ᴛʜᴇ ᴏᴡɴᴇʀ ɢʀᴏᴜᴘ!*',
					ownerB: '*sᴏʀʀʏ, ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜsᴇᴅ ʙʏ ᴛʜᴇ ʙᴏᴛ ᴏᴡɴᴇʀ!* ',
					premium: '*sᴏʀʀʏ ᴛʜɪs ғᴇᴀᴛᴜʀᴇ ɪs ᴏɴʟʏ ғᴏʀ ᴘʀᴇᴍɪᴜᴍ ᴜsᴇʀs!*',
					userB: `*ʜᴇʟʟᴏ ${pushname2} ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ʀᴇɢɪsᴛᴇʀᴇᴅ ɪɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀsᴇ ᴘʟᴇᴀsᴇ ᴛʏᴘᴇ* \n${prefix}daftar`,
					admin: '*sᴏʀʀʏ, ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜsᴇᴅ ʙʏ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴs!*',
					Badmin: '*sᴏʀʀʏ, ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜsᴇᴅ ᴡʜᴇɴ ᴛʜᴇ ʙᴏᴛ ʙᴇᴄᴏᴍᴇs ᴀᴅᴍɪɴ!*',
					publikG: `*sᴏʀʀʏ, ᴛʜᴇ ʙᴏᴛ ʜᴀs ɴᴏᴡ ʙᴇᴇɴ ᴘʀɪᴠᴀᴛɪᴢᴇᴅ ʙʏ ᴛʜᴇ ᴏᴡɴᴇʀ*\n*ғᴏʀ ᴍᴏʀᴇ ᴅᴇᴛᴀɪʟs, ᴛʏᴘᴇ* \n${prefix}infobot`
				}
			}
      ...
      if (messagesLink.includes("://youtu.be/")){
                                        if (!isGroup) return
                                        if (!isAntiLink) return
                                        if (isGroupAdmins) return reply(`*${pushname2}* ɪs ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴ ᴡɪʟʟ ɴᴏᴛ ʙᴇ ᴋɪᴄᴋᴇᴅ`)
                                        denz.updatePresence(from, Presence.composing)
                                        if (messagesLink.includes("#izinadmin")) return reply("#izinadmin *_「 ʀᴇᴄᴇɪᴠᴇᴅ 」_*")
                                        var kic = `${sender.split("@")[0]}@s.whatsapp.net`
                                                reply(`*_「 ɢʀᴏᴜᴘ ʟɪɴᴋ ᴅᴇᴛᴇᴄᴛᴇᴅ 」_*\nsᴏʀʀʏ *${pushname2}* ʏᴏᴜ sᴇɴᴅ ᴀ ɢʀᴏᴜᴘ ʟɪɴᴋ !, ʏᴏᴜ ᴀʀᴇ ɪᴍᴍᴇᴅɪᴀᴛᴇʟʏ ᴋɪᴄᴋᴇᴅ ғʀᴏᴍ ɢʀᴏᴜᴘ *${groupMetadata.subject}*`)
                                                setTimeout( () => {
      ...
      if (messagesLink.includes("://youtube.com/")){
                                        if (!isGroup) return
                                        if (!isAntiLink) return
                                        if (isGroupAdmins) return reply(`*${pushname2}* ɪs ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴ ᴡɪʟʟ ɴᴏᴛ ʙᴇ ᴋɪᴄᴋᴇᴅ`)
                                        denz.updatePresence(from, Presence.composing)
       ...
       if (messagesLink.includes("://chat.whatsapp.com/")){
        ...
        if (messagesLink.includes("hello")){
		denz.updatePresence(from, Presence.composing)
        ...
        if (messagesLink.includes("hi")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/hello.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("hlo")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/hello.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("audio")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/io.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("${prefix}${command}")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/tapi.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("abdu")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/boong.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("falaktak")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/falaktak.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("anzil")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/anzil.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("anu")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/anu.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("jinson")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/jinson.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("sticker")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/AUD-20210303-WA0016.m4a')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("help")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/AUD-20210303-WA0014.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("Abdu")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/AUD-20210303-WA0017.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("WH173 5P1D3R")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/AUD-20210303-WA0017.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("whitespider")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/AUD-20210303-WA0017.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        ...
        if (messagesLink.includes("toimg")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/AUD-20210303-WA0016.m4a')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        ...
        if (messagesLink.includes("menu")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/AUD-20210303-WA0000.m4a')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("ganggang")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/ganggang.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("spotlight")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/spotlight.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("tornapart")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/tornapart.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("ihadadream")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/ihadadream.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("joshapain")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/joshapain.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("fearless")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/fearless.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("ridin")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/song.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("thyre")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/thyre.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("bagboy")){
                denz.updatePresence(from, Presence.composing)
                const loli = fs.readFileSync('./mp3/song2.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("917736807522")){  // respon tag ubah aja
        reply(`*sᴏʀʀʏ ${pushname2}, ᴏᴡɴᴇʀ ᴡʜ𝟷𝟽𝟹 𝟻ᴘ𝟷ᴅ𝟹ʀ ʙᴏᴛ ᴅɪᴅ ɴᴏᴛ ᴀᴄᴄᴇᴘᴛ ᴛᴀɢs!*`)
		...
		reply(`*_「 ʙᴀᴅᴡᴏʀᴅ ᴅᴇᴛᴇᴄᴛᴇᴅ 」_*\nᴍᴀᴀғ *${pushname2}* ᴀɴᴅᴀ ʙᴇʀʙɪᴄᴀʀᴀ ᴋᴏᴛᴏʀ!, ᴀɴᴅᴀ ꜱᴇɢᴇʀᴀ ᴅɪᴋɪᴄᴋ ᴅᴀʀɪ ɢʀᴜᴘ *${groupMetadata.subject}*`)
			...
			switch(command) {
				case 'menu':
					...
					const Menu = {
					text:`╭───「 *_🐱ᴡʜ𝟷𝟽𝟹 𝟻ᴘ𝟷ᴅ𝟹ʀ ʙᴏᴛ🐱_* 」
┣⊱> *USER NAME*: *${pushname2}*
┣⊱> *GROUP NAME*: *${groupMetadata.subject}*
┣⊱> *TIME*: *${time}*
┣⊱> *DATE*: *${date}*
┣⊱> *VERSION*: *3.0*
┣⊱> *USER REGISTERED*: *${user.length} User*
╰────────────────────
├❏ ᴄʀᴇᴀᴛᴏʀ: 🐱ᴡʜ𝟷𝟽𝟹 𝟻ᴘ𝟷ᴅ𝟹ʀ🐱
├❏ ᴘʀᴇғɪx: ${prefix}
...
├❏ ${prefix}ᴘʀᴇᴍɪᴜᴍʟɪꜱᴛ
├❏ ${prefix}ʙᴀʜᴀꜱᴀ
͏͏͏͏͏͏͏͏͏͏͏͏͏͏├───「 *_🐱ᴅᴏᴡɴʟᴏᴀᴅ ᴍᴇɴᴜ🐱_* 」
├❏ ${prefix}ᴛɪᴋᴛᴏᴋꜱᴛᴀʟᴋ
├❏ ${prefix}ɪɢꜱᴛᴀʟᴋ
├❏ ${prefix}ɪɴꜱᴛᴀᴠɪᴅ
├❏ ${prefix}ɪɴꜱᴛᴀɪᴍɢ
...
├❏ ${prefix}ɢᴏᴏɢʟᴇ
├───「 *_🐱ᴍᴏɴᴛᴀɢᴇ sᴏɴɢ🐱_* 」
├❏ɢᴀɴɢɢᴀɴɢ (Badda TD - GANG GANG)
├❏ᴛᴏʀɴᴀᴘᴀʀᴛ (Eredaze - Torn Apart)
├❏ɪʜᴀᴅᴀᴅʀᴇᴀᴍ (Eredaze - I Had A Dream)
├❏sᴘᴏᴛʟɪɢʜᴛ (Tavenchi - Spotlight)
├❏ᴊᴏsʜᴀᴘᴀɪɴ (Josh A - Pain)
├❏ʙᴀɢʙᴏʏ (BrxkenBxy - Bagboy)
├❏ʀɪᴅɪɴ (BrxkenBxy - Ridin)
├───「 *_🐱ᴄʀᴇᴀᴛᴏʀ ᴍᴇɴᴜ🐱_* 」
├❏ ${prefix}ϙᴜᴏᴛᴇᴍᴀᴋᴇʀ
├❏ ${prefix}ɴᴜʟɪꜱ
├❏ ${prefix}ꜱʟɪᴅᴇ
...
├❏ ${prefix}ꜱᴘᴀᴍɢᴍᴀɪʟ
├───「 *_🐱ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ🐱_* 」
├❏ https://tinyurl.com/ydc2hrhs
├❏ https://tinyurl.com/yhcf6wx2 
├───「 *_🐱ᴏᴡɴᴇʀ ᴍᴇɴᴜ🐱_* 」
├❏ ${prefix}ᴀᴅᴅᴘʀᴇᴍ
├❏ ${prefix}ʀᴇᴍᴏᴠᴇᴘʀᴇᴍ
├❏ ${prefix}ᴀᴅᴅʙᴀᴅᴡᴏʀᴅ
...
if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
  ...
  anu = await imgbb("31bff79edfce889df40fa35a1ff9f33c", owgi)
...
case 'hologram':
                 ...
                 if (!isUser) return reply(mess.only.userB)
                                ...
                                denz.sendMessage(from, hehe, ct, {caption: 'Nih kak udah jadi..', quoted: mek})
                                await limitAdd(sender)
                                break
...
case prefix+'tlight':
                                        ...
                                        denz.sendMessage(from, buffer, image, {caption: 'Nih kak', quoted: mek})
                                        await limitAdd(sender)
                                        break
case prefix+'crismes':
                                if (!isUser) return reply(mess.only.userB)
...
quoted: mek, caption: `Wah ganteng kek gua`
  ...
  break
              ...
              case 'tupai':
				...
				case 'daftar':
					denz.updatePresence(from, Presence.composing)
					if (isUser) return reply('*ʏᴏᴜ ᴀʀᴇ ᴀʟʀᴇᴀᴅʏ ᴀ ғʀɪᴇɴᴅ ᴏғ ᴡʜ𝟷𝟽𝟹 𝟻ᴘ𝟷ᴅ𝟹ʀ ʙᴏᴛ☺️*')
					if (isBanned) return reply(mess.only.benned)
					user.push(sender)
					...
					captionnya = `╭─「 *_ʀᴇɢɪsᴛʀᴀᴛɪᴏɴ_* 」\`\`\`\n│ sᴜᴄᴄᴇssғᴜʟ ʀᴇɢɪsᴛʀᴀᴛɪᴏɴ ᴡɪᴛʜ: \n│TM08GK8PPHBSJDH10J\`\`\`\n│\n│\`\`\`ᴏɴ ${date} ${time}\`\`\`\n│\`\`\`「 ɴᴀᴍᴇ 」: ${pushname2}\`\`\`\n│\`\`\`「 ɴᴜᴍʙᴇʀ 」: wa.me/${sender.split("@")[0]}\`\`\`\n│\`\`\`ᴛᴏ ᴜsᴇ  ʙᴏᴛ\`\`\`\n│\`\`\`ᴘʟᴇᴀsᴇ\`\`\`\n│\`\`\`sᴇɴᴅ ${prefix}ʜᴇʟᴘ/ᴍᴇɴᴜ\`\`\`\n│\`\`\`\n│ᴛᴏᴛᴀʟ ᴜsᴇʀs: ${user.length} ᴘᴇʀsᴏɴ\`\`\`\n╰────────────────`
    ...
    case 'infobot':
				...
				case 'info':
					...
					user.push(sender)
					uptime = process.uptime()
					teks = `➽ *ʙᴏᴛ ɴᴀᴍᴇ* : ${me.name}\n➽ *ᴏᴡɴᴇʀ ʙᴏᴛ* : ᴡʜ𝟷𝟽𝟹 𝟻ᴘ𝟷ᴅ𝟹ʀ\n➽ *ᴘʀᴇғɪx* : | ${prefix} |\n➽ *ᴛᴏᴛᴀʟ ʙʟᴏᴄᴋ* : ${blocked.length}\n➽ *ᴀᴄᴛɪᴠᴇᴅ ᴛɪᴍᴇ* : ${kyun(uptime)}\n➽ *ᴛᴏᴛᴀʟ ᴜsᴇʀ* : ${user.length} ᴜꜱᴇʀ\n➽ *ɪɴꜱᴛᴀɢʀᴀᴍ* : https://www.instagram.com/wh173_5p1d3r_official`
...
if (isBanned) return reply(mess.only.benned)
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Example: ${prefix}metallogo W5-BOT`)
metal = body.slice(11)
reply(mess.wait)
...
break
       ...
       exec(`wget ${anu1} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
            ...
            var imgbb = require('imgbb-uploader')
            imgbb('31bff79edfce889df40fa35a1ff9f33c', media)
                .then(data => {
...
case 'testime':
         ...
         case 'lyrics':
                ...
                if (!isUser) return reply(mess.only.userB)
                    ...
                    denz.sendMessage('917736807522@s.whatsapp.net', options, text, {quoted: mek})
...
quoted: mek, caption: `Hasil Dari *${daerah}*`
  ...
  break
				...
				case 'kicktime':
					...
					setTimeout( () => {
					denz.sendMessage(from, `kicking started @${mentioned[0].split('@')[0]}`, text) // ur cods
					}, 5000)
					setTimeout( () => {
					denz.sendMessage(from, 'Byee:D', text)
					}, 2500)
					setTimeout( () => {
				...
				if (isLimit(sender)) return reply(limitend(pushname2))
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						fs.unlinkSync(media)
						if (err) return reply(' *ғᴀɪʟᴇᴅ, ᴡʜᴇɴ ᴄᴏɴᴠᴇʀᴛɪɴɢ sᴛɪᴄᴋᴇʀ ᴛᴏ ɪᴍᴀɢᴇ* ')
						buffer = fs.readFileSync(ran)
						denz.sendMessage(from, buffer, image, {quoted: mek, caption: '*[ᴡʜ𝟷𝟽𝟹 𝟻ᴘ𝟷ᴅ𝟹ʀ ʙᴏᴛ]  sᴜᴄᴄᴇssғᴜʟʟʏ ᴄᴏɴᴠᴇʀᴛ ʏᴏᴜʀ sᴛɪᴄᴋᴇʀ ᴛᴏ ɪᴍᴀɢᴇ*'})
						fs.unlinkSync(ran)
					})
					await limitAdd(sender) 
					break 
     ...
     reply(mess.wait)
         ...
         case 'pinterest':
                                ...
                                if (!isUser) return reply(mess.only.userB)
                                        ...
                                        pinte = body.slice(11)
                                        anu = await fetchJson(`https://api.vhtear.com/pinterest?query=${pinte}&apikey=${vhte}`, {method: 'get'})
                                        reply(mess.wait)
...
break
		...
		case 'spamcall':
			...
			if (isLimit(sender)) return reply(limitend(pushname2))
			spam = `${body.slice(10)}`
			anu = await fetchJson(`https://videfikri.com/api/spamemail/?email=${spam}&subjek=W5.BOT&pesan=You%20were%20hacked%20Soon%20Remember%20It`, {method: 'get'})
			denz.sendMessage(from, `*SUCCESSFULLY SENDED✅*                            *To : ${spam}*                    *Subject: W5.BOT*                            *Message: You were hacked Soon Remember It*                                                                              ⚠️ *Note: Please Use This Feature Only For Pranks.* ⚠️`, text, {quoted: mek})
			await limitAdd(sender) 
			break  
		case 'quransurah':
			if (isBanned) return reply(mess.only.benned)
...
case 'husbu':
			...
			break
				default:
                  ...
                  reply(`*sᴏʀʀʏ, ᴄᴏᴍᴍᴀɴᴅ ${prefix}${command} ɴᴏᴛ ʀᴇɢɪsᴛᴇʀᴇᴅ ɪɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀsᴇ   sᴏ ᴘʟᴇᴀsᴇ ᴛʏᴘᴇ* ${prefix}menu`)
                  }
                  if (isGroup && isSimi && budy != undefined) {
						...
						console.log(color('[WH173 5P1D3R BOT]','aqua'), 'Unregistered Command', color(sender.split('@')[0]))
					}
                           }
		} catch (e) {
